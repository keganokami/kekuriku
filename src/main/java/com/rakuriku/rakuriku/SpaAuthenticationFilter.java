...
public class SpaAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public SpaAuthenticationFilter(AuthenticationManager authenticationManager,
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            return authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(userForm.getUserId(),
